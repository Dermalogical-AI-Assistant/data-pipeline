...
from preprocess.preprocess import preprocess_pages, save_to_db
...
def crawl_lookfantastic_product_detail():
    ...
    from crawl.utils import get_uncrawled_page_urls, get_unsuccessful_urls
    
    uncrawled_page_urls = get_uncrawled_page_urls()
    unsuccessful_urls = get_unsuccessful_urls()
    for page_url in [*uncrawled_page_urls, *unsuccessful_urls]:
